...
class Dual3DCNN6_3f(nn.Module): # FC 256-128-64-32-3
    def __init__(self, width=128, height=128, depth=128):
        super(Dual3DCNN6_3f, self).__init__()
...
# class FlexibleDual3DCNN_3f(nn.Module):
#     def __init__(self, out_channels_list, in_channels=1):
#         super(FlexibleDual3DCNN_3f, self).__init__()
