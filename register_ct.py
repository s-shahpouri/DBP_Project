...
root_patient = "//zkh/appdata/RT-Meetdata/GPTC/13 Research & Testing/DoseBasedPositioning/new_patients_exports3/DBP_OP007/"
name_fixed_CT = 'pCTp0'
...
moving_CT = construct_CT_object(name_moving_CT, path_fixed_CT, path_struct_moving_CT, roi_names = ['External'])
