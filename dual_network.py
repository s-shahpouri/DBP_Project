...
class Dual3DCNN5(nn.Module): # FC 256-128-64-32-3
    def __init__(self, width=128, height=128, depth=128):
        ...
        num_blocks = len(self.num_filters)

        self.kernel_size = [3, 4]  # Define the kernel sizes used in the model
        self.stride = [1, 2]  # Define the strides used in the model
        self.dropout = 0.5
